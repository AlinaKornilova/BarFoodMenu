...
//        SharedManager.shared.selectedProdcutRating = productData.productRating
//        SharedManager.shared.selectedProductViewers = productData.productViewer
        
        let originalRate = SharedManager.shared.selectedProdcutRating
        
//        productRating.text = String(Double(round(10 * originalRate) / 10))
//        prodcutViewers.text = String(SharedManager.shared.selectedProductViewers)
//
